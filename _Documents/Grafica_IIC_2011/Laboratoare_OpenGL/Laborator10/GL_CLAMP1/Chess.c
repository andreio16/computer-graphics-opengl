/*  chess.c
 *  Programul reia programul "cheker.c"
 *  dar cu valori pentru coordonatele de texturare cuprinse între 0 si 3
 *  în conditiile în care se pãstreazã parametrul GL_CLAMP
 */
#include "glos.h"
